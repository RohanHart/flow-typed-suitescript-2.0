...
declare class Object {
  ...
  static (o: ?void): { [key: PropertyKey]: any, ... };
   ...
   * @param o Object on which to lock the attributes.
   */
  static freeze<T: { [key: PropertyKey]: any }>(o: T): $ReadOnly<T>;
   ...
   */
  static getOwnPropertyDescriptor<O: { [key: PropertyKey]: any }, K: $Keys<O>>(
    o: O,
    p: K
  ...
  // https://github.com/facebook/flow/blob/8ac01bc604a6827e6ee9a71b197bb974f8080049/src/typing/statement.ml#L6308
  static keys(o: { [key: PropertyKey]: any }): Array<string>;
   ...
   */
  static preventExtensions<T: { [key: PropertyKey]: any }>(o: T): T;
