/**
 * Flowtype definitions for email
...
declare module 'N/email' {
  ...
  declare interface RelatedRecordTypes {
    /**
  ...
  declare interface CustomRecordObject {
    /**
  ...
  declare interface SendCampaignOptions {
    /**
