/**
 * Flowtype definitions for redirect
...
declare module 'N/redirect' {
  ...
  declare interface ToRecordOptions {
    /**
  ...
  declare interface ToSavedSearchOptions {
    /**
     * Internal ID of the search.
     */
    id: number;
  }
  declare interface ToSearchOptions {
    search: Search;
  }
  declare interface ToSearchResultOptions {
    Search: Search;
  }
  declare interface ToSuiteletOptions {
    /**
  ...
  declare interface ToTaskLinkOptions {
    /**
  ...
  declare export interface NRedirect {
    /**
