...
declare module 'N/ui/serverWidget' {
  ...
  import type { Operator } from "N/search";
  import type { ServerResponse } from "N/http";
  import type {
    AddColumnOptions,
    AddEditColumnOptions,
    AddRowOptions,
    AddRowsOptions
  } from "N/portlet";
  import type { MessageCreateOptions } from "N/ui/message";
  ...
  declare interface UpdateBreakTypeOptions {
     ...
     */
    breakType: $Values<FieldBreakTypeT>;
  }
  ...
  declare interface UpdateDisplayTypeOptions {
     ...
     */
    displayType: $Values<FieldDisplayTypeT>;
  }
  declare interface UpdateLayoutTypeOptions {
     ...
     */
    layoutType: $Values<FieldLayoutTypeT>;
  }
  ...
  declare export interface Assistant {
     ...
     */
    getLastAction(): $Values<AssistantSubmitActionT>;
  ...
  declare export interface Sublist {
    ...
    displayType: $Values<SublistDisplayTypeT>;
    helpText: string;
    label: string;
    lineCount: number;
    name: string;
  ...
  declare type AssistantSubmitActionT = {|
                                         +BACK: 0, // 0
                                         +CANCEL: 1, // 1
                                         +FINISH: 2, // 2
                                         +JUMP: 3, // 3
  ...
  declare type FieldBreakTypeT = {|
                                  +NONE: 0, // 0
                                  +STARTCOL: 1, // 1
                                  +STARTROW: 2 // 2
                                  |};

  declare type FieldDisplayTypeT = {|
                                    +DISABLED: 0, // 0
                                    +ENTRY: 1, // 1
                                    +HIDDEN: 2, // 2
                                    +INLINE: 3, // 3
  ...
  declare type FormPageLinkTypeT = {|
                                    +BREADCRUMB: 0, // 0
                                    +CROSSLINK: 1 // 1
                                    |};

  declare type LayoutJustificationT = {|
                                       +CENTER: 0, // 0
                                       +LEFT: 1, // 1
                                       +RIGHT: 2 // 2
                                       |};

  declare type ListStyleT = {|
                             +GRID: 0, // 0
                             +REPORT: 1, // 1
                             +PLAIN: 2, // 2
                             +NORMAL: 3 // 3
  ...
  declare type SublistDisplayTypeT = {|
                                      +HIDDEN: 0, // 0
                                      +NORMAL: 1 // 1
                                      |};

  declare type SublistTypeT = {|
                               +EDITOR: 0, // 0
                               +INLINEEDITOR: 1, // 1
                               +LIST: 2, // 2
                               +STATICLIST: 3 // 3
  ...
  declare export interface NUi$ServerWidget {
    createList(options: CreateAssistantOptions): List;
    ...
    AssistantSubmitAction: AssistantSubmitActionT;
    FieldBreakType: FieldBreakTypeT;
    FieldDisplayType: FieldDisplayTypeT;
    FieldLayoutType: FieldLayoutTypeT;
    FieldType: FieldTypeT;
    FormPageLinkType: FormPageLinkTypeT;
    LayoutJustification: LayoutJustificationT;
    ListStyle: ListStyleT;
    SublistDisplayType: SublistDisplayTypeT;
    SublistType: SublistTypeT;
  }
