...
declare module 'N/cache' {

  declare export interface LoaderContext {
    key: string;
  }
  ...
  declare export interface PutOptions {
    /**
  ...
  declare export interface GetCacheOptions {
    /**
  ...
  declare export interface NCache {
    /**
