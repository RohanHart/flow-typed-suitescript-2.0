/**
 * Flowtype definitions for SuiteScriptV1
 ...
 * @constructor
 */
declare function nlobjCredentialBuilder(
  request: string,
  domain: string
): NLObjCredentialBuilder;
declare interface NLObjCredentialBuilder {
  /**
...
declare interface NLObjJobRequest {}
...
declare interface NLObjPivotColumn {
  /**
...
declare interface NLObjPivotRow {
  /**
   * Get the row alias.
   */
  getAlias(): string;
...
declare interface NLObjPivotTable {
  /**
...
declare interface NLObjPivotTableHandle {
  /**
...
declare interface NLObjReportColumn {
  /**
...
declare interface NLObjReportColumnHierarchy {
  /**
...
declare interface NLObjReportDefinition {
  /**
  ...
  addColumn(
    ...
    isMeasure: boolean,
    label: string,
    parent?: NLObjReportColumnHierarchy,
    format?: string,
    formula?: string
  ): NLObjReportColumn;
...
declare interface NLObjReportRowHierarchy {
  /**
   * Get the children reference of this column hierarchy.
   */
...
declare interface NLObjReportForm {}
 ...
 */
declare function nlobjSearchColumn(
  name: string,
  join?: string,
  summary?: string
): void;
 ...
 * @param {string} value2
 */
declare function nlobjSearchFilter(
  name: string,
  join: string,
  operator: string,
  value?: string | string[],
...
declare interface NLObjTemplateRenderer {
   ...
   * Perform the merge and return an object containing email subject and body.
   * @governance 20 units
   * @return {{[key: string]: any}} pure javascript object with two properties: subject and body
   */
  merge(): {
    subject: string,
    body: string,
 ...
 */
declare function nlapiCreateFile(
  name: string,
  type: string,
  contents: string
): NLObjFile;
 ...
 */
declare function nlapiGetCurrentLineItemValues(
  type: string,
  fldnam: string
): string[];
 ...
 */
declare function nlapiInitiateWorkflowAsync(
  recordtype: string,
  id: number,
  workflowId: string | number,
  parameters: Object
 ...
 * @deprecated
 */
declare function nlapiMergeTemplate(
  id: number,
  baseType: string,
  baseId: number,
  altType?: string,
 ...
 * @param {string} fldnam sublist field name
 */
declare function nlapiRemoveCurrentLineItemSubrecord(
  type: string,
  fldnam: string
): void;
 ...
 */
declare function nlapiSendCampaignEmail(
 ...
 */
declare function nlapiTriggerWorkflow(
  recordtype: string,
  id: number,
  workflowId: string | number,
