/**
 * Flowtype definitions for serverWidget
...
import type {OperatorT} from 'N/search';
import type {ServerResponse} from 'N/http';

declare module "N/ui/serverWidget" {

declare export var AssistantSubmitAction: {
    BACK: "BACK",
    CANCEL: "CANCEL",
    FINISH: "FINISH",
    JUMP: "JUMP",
...
declare export type AssistantSubmitActionT = $Values<typeof AssistantSubmitAction>

declare export var FieldBreakType: {
    NONE: "NONE",
    STARTCOL: "STARTCOL",
    STARTROW: "STARTROW",
}

declare export type FieldBreakTypeT = $Values<typeof FieldBreakType>

declare export var FieldDisplayType: {
    DISABLED: "DISABLED",
    ENTRY: "ENTRY",
    HIDDEN: "HIDDEN",
    INLINE: "INLINE",
...
declare export type FieldDisplayTypeT = $Values<typeof FieldDisplayType>

declare export var FieldLayoutType: {
    ENDROW: "ENDROW",
    NORMAL: "NORMAL",
    MIDROW: "MIDROW",
    OUTSIDE: "OUTSIDE",
...
declare export type FieldLayoutTypeT = $Values<typeof FieldLayoutType>

declare export var FieldType: {
    CHECKBOX: "CHECKBOX",
    CURRENCY: "CURRENCY",
    DATE: "DATE",
...
declare export type FieldTypeT = $Values<typeof FieldType>

declare export var FormPageLinkType: {
    BREADCRUMB: "BREADCRUMB",
    CROSSLINK: "CROSSLINK",
}

declare export type FormPageLinkTypeT = $Values<typeof FormPageLinkType>

declare export var LayoutJustification: {
    CENTER: "CENTER",
    LEFT: "LEFT",
    RIGHT: "RIGHT",
}

declare export type LayoutJustificationT = $Values<typeof LayoutJustification>

declare export var ListStyle: {
    GRID: "GRID",
    REPORT: "REPORT",
    PLAIN: "PLAIN",
    NORMAL: "NORMAL",
...
declare export type ListStyleT = $Values<typeof ListStyle>

declare export var SublistDisplayType: {
    HIDDEN: "HIDDEN",
    NORMAL: "NORMAL",
}

declare export type SublistDisplayTypeT = $Values<typeof SublistDisplayType>

declare export var SublistType: {
    EDITOR: "EDITOR",
...
declare export type SublistTypeT = $Values<typeof SublistType>
  
declare interface AddButtonOptions {
...
declare interface AddCredentialFieldOptions {
...
declare interface AddFieldGroupOptions {
...
declare interface AddPageLinkOptions {
...
declare interface AddParamToURLOptions {
    param: string,
        value: string,
...
declare interface AddResetButtonOptions {
...
declare interface AddSecretKeyFieldOptions {
...
declare export interface AddSelectOptionOptions {
    value: string,
        text: string,
        isSelected?: boolean
}
declare interface AddSublistOptions {
...
declare interface AddSubmitButtonOptions {
...
declare interface AddSubtabOptions {
...
declare interface CreateAssistantOptions {
...
declare interface GetFieldIdsByFIeldGroupOptions {
...
declare interface GetSelectOptionsOpts {
    ...
    filter?: string,
         ...
         */
        filteroperator?: OperatorT
}
declare interface GetSublistFieldIdsOptions {
...
declare interface InsertFieldOptions {
...
declare interface InsertSublistOptions {
...
declare interface InsertTabOptions {
...
declare interface InsertSubtabOptions {
...
declare interface SetHelpTextOptions {
...
declare interface SublistGetSublistValueOptions {
...
declare interface SublistSetSublistValueOptions {
...
declare interface SetSplashOptions {
...
declare interface SetURLOptions {
...
declare interface UpdateBreakTypeOptions {

    /**
     * The break type of the field. 
     */
    breakType: FieldBreakTypeT
}
declare interface UpdateDisplaySizeOptions {
 ...
 */
declare export interface Assistant {
    ...
    addField(options: AddFieldOptions): Field,
         ...
         */
        getLastAction(): AssistantSubmitActionT,
...
declare export interface AssistantStep {
 ...
 */
declare export interface FieldGroup {
...
declare export interface BaseForm {
    addField(options: AddFieldOptions): Field,
...
declare export interface Sublist {
    ...
    addButton(options: AddButtonOptions): Button,
        ...
        displayType: SublistDisplayTypeT,
        helpText: string,
        label: string,
        lineCount: number
}
...
declare export function createAssistant(options: CreateAssistantOptions): Assistant
/**
 * Creates a form object.
 */
  declare export function createForm(options: CreateAssistantOptions): Form
